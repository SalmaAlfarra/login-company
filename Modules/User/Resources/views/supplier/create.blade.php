    ...
    <div class="card card-custom example example-compact">
        ...
        <form class="form">
            <div class="card-body">
                ...
                <div class="separator separator-dashed my-10"></div>
                <div class="form-group row mt-4">
                    <label class="col-lg-1 col-form-label text-lg-right">البريد الإلكتروني : </label>
                    <div class="col-lg-5">
                        <input type="email" class="form-control form-control-solid" placeholder="البريد الإلكتروني">
                        <span class="form-text text-muted">أدخل البريد الإلكتروني للموزع </span>
                    </div>
                </div>
                <div class="separator separator-dashed my-10"></div>
                <div class="form-group row mt-4">
                    ...
                    <div class="col-lg-5">
                        ...
                        <span class="form-text text-muted">أدخل عنوان سكن للموزع </span>
                    </div>
                </div>
            </div>
