...
@section('content')
    <section class="app-user-list">
                    ...
                    <div class="dt-buttons btn-group flex-wrap ">
                        <a href="{{ route('acquaintance.create') }}" class="btn add-new btn-primary mt-50"
                            style="margin: 20px;">Add acquaintance</a>
                    </div>
                    <!-- list section start -->
                    <div class="card">
