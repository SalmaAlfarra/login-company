...
@section('content')
    <div class="card card-custom example example-compact">
        ...
        <!--begin::Form-->
        <form class="form" action="{{route('category.create')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group row mt-4">
                    <label class="col-lg-1 col-form-label text-lg-right">اسم الصنف : </label>
                    <div class="col-lg-6">
                        <input type="text" name="name" class="form-control form-control-solid" placeholder="اسم الصنف">
                ...
                <div class="form-group row mt-4">
                    ...
                    <div class="col-lg-6">
                        <textarea class="form-control form-control-solid" name="description" id="exampleTextarea" rows="3"placeholder="وصف الصنف"></textarea>
