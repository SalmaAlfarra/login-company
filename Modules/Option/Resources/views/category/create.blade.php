        ...
        <form class="form">
            <div class="card-body">
                <div class="form-group row mt-4">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control form-control-solid" placeholder="اسم الصنف">
                ...
                <div class="form-group row mt-4">
                    ...
                    <div class="col-lg-6">
                        <textarea class="form-control form-control-solid" id="exampleTextarea" rows="3"placeholder="وصف الصنف"></textarea>
