...
return [
    ...
    'password' => [
        ...
        'mixed' => 'يجب أن تحتوي كلمة المرور على حرف واحد كبير وحرف صغير واحد على الأقل.',
        'numbers' => 'يجب أن تحتوي كلمة المرور على رقم واحد على الأقل.',
        'symbols' => 'يجب أن تحتوي كلمة المرور على رمز واحد على الأقل.',
        'uncompromised' => 'ظهرت كلمة المرور المقدمة في حالة تسرب البيانات. الرجاء اختيار كلمة مرور مختلفة.',
    ],
    ...
    'attributes' => [
        ...
        'message' => 'الرسالة',
        'check_report' => 'تقرير فحص المركبة',
        'reserve_price' => 'السعر الأدنى للبيع',
        'make_id' => 'المصنع',
        'model_id' => 'الطراز',
        'manufacture_year' => 'السنة',
        'exterior_color_id' => 'اللون الخارجي',
        'interior_color_id' => 'اللون الداخلي',
        'odometer_read' => 'قراءة عداد المسافة',
        'vin' => 'رقم القاعدة',
        'fuel_type_id' => 'نوع الوقود',
        'interior_material_id' => 'مواد الفرش الداخلي',
        'transmission_id' => 'ناقل المركبة',
        'car_origin' => 'مصدر المركبة',
        'country_origin_id' => 'دولة الإستيراد',
